...
1. What is an array in Javascript?
    ...
    An array is a data structure that holds an ordered list of items denoted within square brackets. Each slot in a JavaScript array can hold any type of data.
...
4. What is a property? A method?
    ...
    Data items contained in an object are referred to as properties, and functions on an object are referred to as methods.

5. Why are loops useful when dealing with arrays?

    Loops allow us to iterate through elements in an array. To iterate means to repeat a process to achieve a desired result. When you iterate over an array, it        means that you cycle/traverse through the indices and elements of the array. 
